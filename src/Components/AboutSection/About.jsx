        ...
        <div className={styles.mainCont}>
          ...
          <div className={styles.headingAndText}>
            ...
            <Text className={styles.text}>
              full-stack developer who is analytical and detail-oriented and is
              capable of writing production-ready code using ReactJS, Redux, and
              CSS on the frontend and NodeJS and Express on the backend to build
              an efficient single-page application. passionate about coding and
              intensely interested in working with a product-based company
            </Text>
          </div>
        </div>
      </Box>
